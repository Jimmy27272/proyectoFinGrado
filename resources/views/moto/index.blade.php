<x-app-layout bodyClass="page-my-moto">
    <main>
        <div>
          <div class="container">
            <h1 class="moto-details-page-title">Mis Motos</h1>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="">
                        ...
                        <form action="{{route('moto.destroy', $moto)}}"
                          method="POST" class="inline-flex">
                          @csrf
                          @method('DELETE')
                          <button onclick="return confirm('¿Estás seguro que quieres eliminar ésta moto?')" class="btn btn-delete inline-flex items-center">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                    ...
                    <tr>
                      <td colspan="5" class="text-center p-large">
                        No hay motos registradas. <a href="{{route('moto.create')}}">¡Agrega una!</a>
                      </td>
                    @endforelse
                  </tbody>
                </table>
